...
`[IMAGE PLACEHOLDER: Simulink block diagram of the PID controller and robot dynamics]`
*Robot dynamics and control loop modeled in Simulink*
...
`[IMAGE PLACEHOLDER: torque/angle scope trace during disturbance testing]` `[IMAGE PLACEHOLDER: CAD render of the wheeled chassis]`
*Response to induced disturbances — torque output tracking commanded angle correction*
...
`[IMAGE PLACEHOLDER: photo of assembled final robot]`
*Final assembled robot*

`[IMAGE PLACEHOLDER: photo of wireless PID tuning device with Kp/Ki/Kd/Set-point dials]`
*Wireless PID tuning device built around an Arduino Nano and NRF24L01 module*
