...
project explores what happens when you flip that — treating a
...
- Both controllers converged to nearly identical optimal
  morphologies independently, suggesting the task itself — not the
...
- Each morphology performed best paired with the controller it was
  co-designed with — direct evidence that link geometry, trajectory,
